...
cpflow apply-template \
  app-inertia r2 mysql dynamodb redis elasticsearch memcached rails sidekiq \
  --app gumroad-inertia \
  --org "$CPLN_ORG" \
  --yes
```
