...
const renderLegacyFeaturedProduct: FeaturedProductRenderer = ({ props, selection, setSelection }) => (
...
export const Section = ({
  ...
  <ProfileSectionFrame id={section.id} header={section.header}>
    {section.type === "SellerProfileProductsSection" ? (
      ...
      (postsContent ?? <PostsView posts={section.posts} />)
      ...
      <FeaturedProductSectionView
        key={section.id}
        section={section}
        renderFeaturedProduct={renderFeaturedProduct ?? renderLegacyFeaturedProduct}
      />
    ) : (
