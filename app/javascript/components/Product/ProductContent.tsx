...
import type { Purchase } from "$app/components/Product";
import { AuthorByline } from "$app/components/Product/AuthorByline";
import { getNotForSaleMessage } from "$app/components/Product/productAvailability";
import { DEFAULT_IMAGE_WIDTH, PRODUCT_COVER_SIZES } from "$app/components/Product/productCover";
import {
...
export const ProductSellerAndRatings = ({
  content,
  ...
  const showSellerByline = seller && !(hideSellerByline && !collaboratingUser);
