...
const publicOutputPath = path.join(rootPath, "public/public-rsc");
...
const publicAssetPath = mode === "production" ? "/assets/public-rsc/" : "/public-rsc/";
...
const serverAssetRule = {
  ...assetRule,
  generator: {
    ...assetRule.generator,
    outputPath: path.relative(privateOutputPath, publicOutputPath),
    publicPath: publicAssetPath,
  },
};

const createPlugins = (ssr, includeRscPlugin = true) => [
