...
export default defineConfig({
  shared: {
    ...
    experimentURL: `http://experim.localhost:${EXPERIMENT_PORT}`,
  ...
  twinServers: {
    copyIgnore: {
      folders: [".history", "benchmark-results"],
    },
    ...
    procfile: join(projectDir, "twin-servers/Procfile"),
    composeFile: join(projectDir, "twin-servers/docker-compose.yml"),
    ...
    setupCommands: [
      ...
      {
        command: "/shakaperf-twin/build-public-rsc",
        description: "Building side-specific RSC assets",
      },
      {
